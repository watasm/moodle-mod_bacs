...
$string['modulename_help'] = 'Una actividad BACS añade un evaluador automático de código a tu curso: úsala como una tarea calificada o como un concurso en vivo. Los estudiantes envían su código fuente y reciben veredictos instantáneos por cada prueba (tiempo de ejecución, memoria y resultado), mientras un monitor en vivo clasifica a los participantes en tiempo real. Admite los sistemas de puntuación IOI, ICPC y personalizado, grupos y participación virtual, y colecciones de problemas multilingües listas para usar, evaluadas por el juez externo Sybon, sin necesidad de instalar un servidor de evaluación. El profesorado dispone además de analíticas detalladas de progreso y dificultad.';
...
// Strings backfilled to match the English reference set.
$string['add_btn'] = '+ Añadir';
$string['advancededitor'] = 'Editor avanzado';
$string['allmaintestsconfigured'] = 'Todas las pruebas principales configuradas';
$string['allparticipants'] = 'Todos los participantes';
$string['apply'] = 'Aplicar';
$string['auto'] = 'Auto';
$string['availabletasks'] = 'Tareas disponibles';
$string['cannotconfigdeletedtask'] = 'No se puede configurar una tarea eliminada';
$string['chart_mode_normalized'] = 'Normalizado (Carrera)';
$string['chart_mode_realtime'] = 'Tiempo real';
$string['classsession'] = 'Período activo';
$string['classsessiondetails'] = 'Detalles de la sesión de clase';
$string['clearall'] = 'Limpiar todo';
$string['clicktoviewsubs'] = 'Haz clic para ver todos los envíos';
$string['configpoints'] = 'Configurar puntos';
$string['configsybondomain'] = 'Dominio base para los servidores Sybon (p. ej. sybon.ru o sybon.org)';
$string['create10'] = 'Crear 10';
$string['create20'] = 'Crear 20';
$string['day_short'] = 'día';
$string['days_short'] = 'días';
$string['disablecompression'] = 'Sin compresión de tiempo';
$string['dragreorder'] = 'Arrastra para reordenar';
$string['elapsedfromstart'] = 'Transcurrido desde el inicio: +';
$string['end'] = 'Fin';
$string['endofcontest'] = 'Fin del concurso';
$string['event'] = 'Evento';
$string['events'] = 'Eventos';
$string['fail'] = 'FALLO';
$string['firstaccepted'] = 'Primer aceptado:';
$string['firstname'] = 'Nombre';
$string['flatpickr_end'] = 'Fin';
$string['flatpickr_help'] = 'Puedes seleccionar una fecha en el calendario o introducirla manualmente. Formato: <b>YYYY-MM-DD HH:MM</b>';
$string['flatpickr_start'] = 'Inicio';
$string['full_points'] = 'Completo:';
$string['go_to_submission'] = 'Ir al envío';
$string['go_to_tasks'] = 'Enviar soluciones';
$string['hidestatement_btn'] = '👁 Ocultar enunciado';
$string['hour_short'] = 'hora';
$string['hours_short'] = 'horas';
$string['includepretests'] = 'Incluir pre-pruebas';
$string['interval'] = 'Intervalo';
$string['lastname'] = 'Apellido';
$string['maintest'] = 'Prueba principal';
$string['min_short'] = 'min';
$string['mode_general'] = 'General';
$string['mode_general_desc'] = 'Configuración de reglas personalizada.';
$string['mode_icpc_desc'] = 'Puntuación binaria, tiempo de penalización.';
$string['mode_ioi_desc'] = 'Puntos por prueba, puntuación parcial.';
$string['networkerror'] = '¡Error de red al enviar!';
$string['no_permission_statements'] = 'No tienes permiso para ver los enunciados de las tareas.';
$string['no_tasks_available'] = 'Todavía no hay tareas disponibles en este concurso.';
$string['nodata'] = 'Sin datos';
$string['nodatadesc'] = 'No se encontraron envíos para los filtros seleccionados.';
$string['normalizeto'] = 'Normalizar a:';
$string['nostatement'] = 'No hay enunciado disponible';
$string['nosubmits'] = 'Sin envíos';
$string['nosubmitsdesc'] = 'El participante {user} no ha enviado soluciones para la tarea {task}.';
$string['notasksyet'] = 'Todavía no hay envíos en el concurso';
$string['notasksyetdesc'] = 'El gráfico aparecerá en cuanto los participantes empiecen a enviar soluciones.';
$string['onlypretests'] = 'Solo pre-pruebas';
$string['open_link'] = 'Abrir ↗';
$string['participant'] = 'Participante';
$string['participants'] = 'Participantes';
$string['period'] = 'Período:';
$string['pointsforfullsolution_label'] = 'Puntos por solución completa (Aceptado):';
$string['pointssettings'] = 'Configuración de puntos';
$string['pre_count'] = 'pre';
$string['progress_to_max'] = 'Progreso hacia la puntuación máxima del concurso (%)';
$string['race_empty_desc'] = 'El gráfico de dinámica de líderes aparecerá aquí automáticamente en cuanto los participantes empiecen a enviar soluciones.';
$string['race_empty_title'] = 'La carrera aún no ha comenzado';
$string['rank'] = 'Posición:';
$string['rawdatacomma'] = 'Datos sin procesar (separados por comas):';
$string['removefromcontest'] = 'Quitar del concurso';
$string['removetask'] = 'Quitar tarea';
$string['resetzoom'] = 'Restablecer zoom';
$string['results_empty_desc'] = 'La dinámica de puntuación individual aparecerá aquí. ¡Envía una solución para iniciar el gráfico!';
$string['results_empty_title'] = 'El gráfico de resultados está vacío';
$string['scale_btn'] = 'Escalar';
$string['score'] = 'Puntuación:';
$string['select_language'] = 'Seleccionar idioma';
$string['select_task'] = 'Seleccionar tarea';
$string['selectedtasks'] = 'Tareas seleccionadas';
$string['set_btn'] = 'Establecer';
$string['showmaxpoints'] = 'Mostrar puntuación máxima';
$string['showmaxpoints_help'] = 'Si está activado, los estudiantes verán la puntuación máxima posible junto a su resultado actual (p. ej., "80/100").';
$string['showstatement_btn'] = '👁‍🗨 Mostrar enunciado';
$string['solutionsentwait'] = '¡Solución enviada! Esperando el resultado...';
$string['spammeranomaly'] = 'Anomalía de spam detectada';
$string['splitfullname'] = 'Separar nombre completo';
$string['start'] = 'Inicio';
$string['stat_confidence'] = 'Confianza';
$string['stat_contests'] = 'Concursos';
$string['stat_expert'] = 'Valoración experta';
$string['stat_init'] = 'Valoración inicial';
$string['stat_max'] = 'Valoración máxima';
$string['stat_min'] = 'Valoración mínima';
$string['stat_rating'] = 'Valoración';
$string['stat_seen'] = 'Vistas';
$string['stat_solved'] = 'Resuelto';
$string['stat_submits'] = 'Envíos';
$string['statsok'] = 'OK';
$string['statssuccess'] = 'TASA DE ÉXITO';
$string['statstotal'] = 'TOTAL';
$string['step'] = 'Paso';
$string['submissionsdetails'] = 'Detalles de los envíos';
$string['subs'] = 'env.';
$string['successful_submissions_seq'] = 'Envíos exitosos (secuencia)';
$string['sybondomain'] = 'Dominio de la API de Sybon';
$string['task_statement_title'] = 'Enunciado de la tarea {$a}';
$string['taskdeletedfromdb'] = '¡TAREA ELIMINADA DE LA BD! Quítala del concurso.';
$string['taskmanager'] = 'Gestor de tareas';
$string['tasknotfoundid'] = '[TAREA NO ENCONTRADA, ID = {id}]';
$string['tasknotsolvedyet'] = 'Tarea aún no resuelta';
$string['tasknotsolvedyetdesc'] = 'Nadie ha enviado soluciones para la tarea {task} todavía.';
$string['taskrating'] = 'Valoración de la tarea: {rating}';
$string['testcountundefined'] = 'El número de pruebas no está definido.';
$string['tests_count'] = 'pruebas';
$string['tests_label'] = 'Pruebas:';
$string['tests_pre_header'] = 'Pruebas (Pre)';
$string['testspretests'] = 'Pruebas / Pre-pruebas';
$string['timefromstart'] = 'Tiempo desde el inicio';
$string['timing'] = 'Horario';
$string['topparticipants'] = 'Mejores participantes';
$string['toptasks'] = 'Tareas populares';
$string['total'] = 'total';
$string['total_label'] = 'Total:';
$string['totalsubmits'] = 'Total de envíos:';
$string['upsolving_label'] = 'Resolución posterior';
$string['usernotsubmittedyet'] = 'El participante aún no ha enviado nada';
$string['usernotsubmittedyetdesc'] = 'El participante {user} aún no ha enviado nada.';
$string['usersactive'] = 'Usuarios activos:';
$string['usr'] = 'usr';
$string['value_short'] = 'Val';
$string['verdict_not_ok'] = 'Fallido';
$string['verdict_ok'] = 'Aceptado';
$string['view'] = 'Vista';
$string['view_monitor'] = 'Participantes';
$string['virtual'] = 'Virtual';
$string['warningzeropoints'] = 'Advertencia: contiene pruebas con 0 puntos';
$string['week_short'] = 'semana';
$string['ws_offline_fallback'] = 'Debes actualizar la página manualmente para ver los resultados de la comprobación.';