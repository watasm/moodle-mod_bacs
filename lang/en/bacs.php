...
$string['modulename_help'] = 'A BACS activity adds an automatic code grader to your course — run it as a graded coding assignment or as a full live contest. Students submit source code and receive instant per-test verdicts (execution time, memory and results), while a live monitor ranks participants in real time. It supports IOI, ICPC and custom scoring, groups and virtual participation, and ready-made multilingual problem collections checked by the external Sybon judge — no judging server to install. Teachers also get rich progress and difficulty analytics.';
...
$string['hour_short'] = 'hour';
$string['hours_short'] = 'hours';
$string['day_short'] = 'day';
$string['days_short'] = 'days';
$string['week_short'] = 'week';
$string['resetzoom'] = 'Reset Zoom';
$string['view'] = 'View';
$string['apply'] = 'Apply';
$string['nodata'] = 'No data';
$string['nodatadesc'] = 'No submissions found for the selected filters.';
$string['notasksyet'] = 'No submissions in the contest yet';
$string['notasksyetdesc'] = 'The chart will appear as soon as participants start submitting solutions.';
$string['tasknotsolvedyet'] = 'Task not solved yet';
$string['tasknotsolvedyetdesc'] = 'Nobody has submitted solutions for task {task} yet.';
$string['usernotsubmittedyet'] = 'Participant hasn\'t submitted yet';
$string['usernotsubmittedyetdesc'] = 'Participant {user} hasn\'t submitted anything yet.';
$string['nosubmits'] = 'No submissions';
$string['nosubmitsdesc'] = 'Participant {user} hasn\'t submitted solutions for task {task}.';
$string['endofcontest'] = 'End of Contest';
$string['classsession'] = 'Class Session';
$string['usersactive'] = 'Users active:';
$string['totalsubmits'] = 'Total Submits:';
$string['spammeranomaly'] = 'Spammer anomaly detected';
$string['toptasks'] = 'Top Tasks';
$string['clicktoviewsubs'] = 'Click to view all submissions';
$string['period'] = 'Period:';
$string['elapsedfromstart'] = 'Elapsed from start: +';
$string['firstaccepted'] = 'First Accepted:';
$string['submissionsdetails'] = 'Submissions details';
$string['classsessiondetails'] = 'Class Session Details';
$string['total'] = 'total';
$string['upsolving_label'] = 'Upsolving';
$string['fail'] = 'FAIL';
$string['subs'] = 'subs';
$string['usr'] = 'usr';
...
$string['statsok'] = 'OK';
$string['statssuccess'] = 'SUCCESS RATE';
$string['events'] = 'Events';
$string['step'] = 'Step';
$string['results_empty_title'] = 'Results graph is empty';
$string['results_empty_desc'] = 'Individual score dynamics will appear here. Submit a solution to start the graph!';
$string['race_empty_title'] = 'The race hasn\'t started yet';
$string['race_empty_desc'] = 'Leader dynamics chart will appear here automatically as soon as participants start submitting solutions.';
$string['score'] = 'Score:';
$string['start'] = 'Start';
$string['end'] = 'End';
$string['progress_to_max'] = 'Progress to Contest Max Score (%)';
$string['successful_submissions_seq'] = 'Successful Submissions (Sequence)';
$string['rank'] = 'Rank:';
$string['event'] = 'Event';
$string['topparticipants'] = 'Top Participants';
$string['advancededitor'] = 'Advanced Editor';
$string['taskmanager'] = 'Task Manager';
$string['hidestatement_btn'] = '👁 Hide Statement';
$string['showstatement_btn'] = '👁‍🗨 Show Statement';
$string['open_link'] = 'Open ↗';
$string['availabletasks'] = 'Available Tasks';
$string['selectedtasks'] = 'Selected Tasks';
$string['pointsforfullsolution_label'] = 'Points for full solution (Accepted):';
$string['tests_label'] = 'Tests:';
$string['set_btn'] = 'Set';
$string['normalizeto'] = 'Normalize to:';
$string['scale_btn'] = 'Scale';
$string['includepretests'] = 'Include pretests';
$string['clearall'] = 'Clear All';
$string['testcountundefined'] = 'Test count is undefined.';
$string['create10'] = 'Create 10';
$string['create20'] = 'Create 20';
$string['rawdatacomma'] = 'Raw Data (Comma separated):';
$string['total_label'] = 'Total:';
$string['tasknotfoundid'] = '[TASK NOT FOUND, ID = {id}]';
$string['warningzeropoints'] = 'Warning: Contains tests with 0 points';
$string['taskdeletedfromdb'] = 'TASK DELETED FROM DB! Remove it from the contest.';
$string['allmaintestsconfigured'] = 'All main tests configured';
$string['onlypretests'] = 'Pretests only';
$string['taskrating'] = 'Task rating: {rating}';
$string['cannotconfigdeletedtask'] = 'Cannot configure deleted task';
$string['configpoints'] = 'Configure points';
$string['removefromcontest'] = 'Remove from contest';
$string['tests_count'] = 'tests';
$string['pre_count'] = 'pre';
$string['full_points'] = 'Full:';
$string['dragreorder'] = 'Drag to reorder';
$string['timelimit'] = 'Time Limit';
$string['memorylimit'] = 'Memory Limit';
$string['testspretests'] = 'Tests / Pretests';
$string['add_btn'] = '+ Add';
$string['removetask'] = 'Remove Task';
$string['pointssettings'] = 'Points Settings';
$string['nostatement'] = 'No statement available';
$string['pretest'] = 'Pretest';
$string['maintest'] = 'Main Test';
$string['flatpickr_start'] = 'Start';
$string['flatpickr_end'] = 'End';
$string['flatpickr_help'] = 'You can select a date in the calendar or enter it manually. Format: <b>YYYY-MM-DD HH:MM</b>';
$string['mode_general'] = 'General';
$string['mode_ioi_desc'] = 'Points per test, partial scoring.';
$string['mode_icpc_desc'] = 'Binary scoring, penalty time.';
$string['mode_general_desc'] = 'Custom rules configuration.';
$string['tests_pre_header'] = 'Tests (Pre)';
$string['value_short'] = 'Val';
$string['go_to_tasks'] = 'Submit solutions';
$string['select_language'] = 'Select language';
$string['go_to_submission'] = 'Go to submission';
...
$string['stat_submits'] = 'Submits';
$string['stat_contests'] = 'Contests';
$string['stat_seen'] = 'Seen by';
$string['stat_solved'] = 'Solved';
$string['stat_rating'] = 'Rating';
$string['stat_init'] = 'Init Rating';
$string['stat_expert'] = 'Expert Rating';
